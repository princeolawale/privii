...
export function SiteHeader({
  ...
  return (
    <>
      <header
        className={cn(
          "sticky top-0 z-40 mb-5 flex items-center justify-between bg-black px-4 py-3 sm:rounded-b-[28px] sm:border-x sm:border-b sm:border-white/[0.05] sm:px-5 sm:py-3",
          marketing ? "mb-5" : "mb-6"
        )}
      >
        <BrandMark />
